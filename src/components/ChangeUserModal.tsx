...
const ChangeUserModal: React.FC<ChangeUserModalProps> = ({
  ...
  const { currentUser, handleCurrentUser } = useContext(dataContext);

  const handleChangeUser = (e?: React.SyntheticEvent) => {
    if (e) {
      e.preventDefault();
    }
  ...
  useEffect(() => {
    localStorage.setItem('trelloCloneUser', currentUser);
  }, [currentUser]);
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div className="mt-2">
                  <form
                    ...
                    onSubmit={(e: React.SyntheticEvent) => handleChangeUser(e)}
                  >
                    <div className="mb-4">
                      <label
